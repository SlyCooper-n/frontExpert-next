...
export function Header() {
  return (
    <header className="font-bold">
      <nav className="mx-auto flex max-w-7xl flex-col items-center justify-between py-16 px-2 md:flex-row">
        <Link href="/">
        ...
        <ul className="mt-10 flex gap-4 md:mt-0">
          <li>
            <Link href="/">
              <a
                className={` text flex min-h-[56px] items-center rounded-full border-2 border-[#d9d9d9] px-6 text-[#626264] transition-colors hover:border-brand-500 hover:bg-brand-500 hover:text-white`}
              >
